...
extern uint64 sys_getyear(void); //Prototype for the system call handler function.
...
[SYS_getyear]  sys_getyear, //Map the system call number to the system call handler function.
[SYS_fork]    sys_fork,
[SYS_exit]    sys_exit,
[SYS_wait]    sys_wait,
[SYS_pipe]    sys_pipe,
